...
function deleteBorrow(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:5181/api/BorrowDetails/${id}`, {
            method: 'DELETE'
        });
        if (!response.ok) {
...
function conform_purchase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let books = yield fetchBookDetails();
        if (book_count.value != "") {
            books.forEach(book => {
...
function returnPage() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        document.getElementById("walletrecharge_page").style.display = "none";
        document.getElementById("purchase_book").style.display = "none";
        let return_table = document.getElementById("return_table");
        let history = yield fetchBorrowDetails();
